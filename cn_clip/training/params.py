...
def parse_args():
    ...
    parser.add_argument(
        "--train-data",
        type=str,
        default='/media/dell/DATA/Chinese-CLIP-master/shujuji/datasets/MUGE/lmdb/train',
        help="Path to the LMDB directory with training data split",
    )  # required=True,
    parser.add_argument(
        "--val-data",
        type=str,
        default='/media/dell/DATA/Chinese-CLIP-master/shujuji/datasets/MUGE/lmdb/valid',
    ...
    parser.add_argument(
        "--resume",
        default='/media/dell/DATA/Chinese-CLIP-master/shujuji/pretrained_weights/clip_cn_vit-b-16.pt',
        type=str,

...
def main():
    ...
    os.environ["LOCAL_RANK"] = str(0) #gai
    ...
    dist.init_process_group(backend="nccl", init_method='env://', rank=0, world_size=1)  # gai
...
if __name__ == "__main__":
    ...
    '''
    --train-data=data/datasets/MUGE/lmdb/train
          --val-data=ta/datasets/MUGE/lmdb/valid

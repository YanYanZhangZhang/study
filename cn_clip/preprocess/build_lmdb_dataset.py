...
def parse_args():
    ...
    parser.add_argument(
        "--data_dir", type=str, default='/media/dell/DATA/Chinese-CLIP-master/shujuji/datasets/ss', help="the directory which stores the image tsvfiles and the text jsonl annotations"
    )  # required=True,
    parser.add_argument(
        "--splits", type=str, default='train', help="specify the dataset splits which this script processes, concatenated by comma \
